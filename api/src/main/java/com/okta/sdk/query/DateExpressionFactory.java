...
public interface DateExpressionFactory {
    ...
    /**
     * Returns a new expression indicating the property value must belong to the range specified by the {@code begin} and {@code end} dates
     ...
     * @return a Criterion representing a given date range.
     */
