 ...
 * {@link com.okta.sdk.application.Application#authenticateAccount(AuthenticationRequest) Application
 ...
 * authentication attempts by ApiKey ({@link com.okta.sdk.api.ApiAuthenticationResult}), OAuth Bearer Token,
 * ({@link com.okta.sdk.oauth.OAuthAuthenticationResult OAuthAuthenticationResult}, or OAuth
 * via ApiKey as a <a href="http://tools.ietf.org/html/rfc6749#section-2.3.1">Client Credentials Grant Type</a> request
 * ({@link com.okta.sdk.oauth.AccessTokenResult AccessTokenResult}).</p>
 *
 * <p>
...
public interface AuthenticationResult extends Resource {
     ...
     * result indistinctively of the authentication request type used.
     *
