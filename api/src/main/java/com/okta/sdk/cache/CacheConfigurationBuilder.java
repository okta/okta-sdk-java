 ...
 * the {@link CacheManagerBuilder}. CacheConfigurationBuilders can be constructed with the {@link Caches Caches} utility
 * class. For example:
 *
 * <pre>
...
public interface CacheConfigurationBuilder {
     ...
     * <p>
     * If this value is not configured, it is assumed that the Cache's entries could potentially live indefinitely. Note
     ...
     *
     * @param ttl
     *            Time To Live scalar value
     * @param ttlTimeUnit
     *            Time to Live unit of time
     *
     ...
     *
     * @param tti
     *            Time To Idle scalar value
     * @param ttiTimeUnit
     *            Time to Idle unit of time
     *
