...
public class EmailCustomizationApiTest {
    ...
    public void testGetObjectMapperConfiguration() throws Exception {
        java.lang.reflect.Method method = com.okta.sdk.resource.api.EmailCustomizationApi.class
            .getDeclaredMethod("getObjectMapper");
        method.setAccessible(true);
        ObjectMapper mapper = (ObjectMapper) method.invoke(api);
