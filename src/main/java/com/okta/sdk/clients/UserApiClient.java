...
public class UserApiClient extends JsonApiClient {
     ...
     *
     * @param  query {@link String}                  The to be searched for
     * @return {@link List}                          Users containing matching results.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param limit {@link Integer}                  Maximum number of Users to return.
     * @return {@link List}                          Users containing matching results.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     * @return {@link List}                          Users that match the given {@code filter}.
     * @throws IOException                           If an input or output exception occurred.
     ...
     * @return {@link List}                          Users that is fetched from the {@code url}.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @return {@link User}                          The user object.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                 The id of the returned user.
     * @return {@link User}                          The user with id equal to {@code userId}.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  user {@link User}                     The user to be created.
     * @return {@link User}                          The user that's created.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  user {@link User}                     The user to be created.
     * @param  activate {@link Boolean}              Determines whether to activate the user.
     * @return {@link User}                          The user that's created.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  firstName {@link String}              The first name of the user.
     * @param  lastName {@link String}               The last name of the user.
     * @param  login {@link String}                  The login of the user.
     ...
     * @param  login {@link String}                  The login of the user.
     * @param  email {@link String}                  The email of the user.
     * @param  secondEmail {@link String}            The secondary email of the user.
     * @return {@link User}                          The user that's created.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     * @param  email {@link String}                  The email of the user.
     * @param  secondEmail {@link String}            The secondary email of the user.
     * @param  mobilePhone {@link String}            The mobile phone number of the user.
     * @return {@link User}                          The user that's created.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     * @param  login {@link String}                  The login of the user.
     * @param  email {@link String}                  The email of the user.
     * @param  activate {@link Boolean}              To activate the user.
     * @return {@link User}                          The user that's created.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                 The id of the user to get groups for.
     * @return {@link List}                          The groups the user with id equal to {@code userId} is member of.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  params {@link User}                   The user parameters to be updated.
     ...
     * Update a user with parameters. Any non-specified properties are removed.
     *
     * @param  userId {@link String}                 The id of the user to be updated.
     * @param  params {@link User}                   The user parameters to be updated.
     * @return {@link User}                          The updated user.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     * Delete a user.
     *
     * @param  userId {@link String}                 The id of the user to be deleted.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     * Activate user.
     *
     * @param  userId {@link String}                 The id of the user to be activated.
     ...
     *
     * @param  userId {@link String}                 The id of the user to be activated.
     * @param  sendEmail {@link Boolean}             Determines whether to send an activate email.
     * @return {@link User}                          The activated user.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     * Deactivate a user.
     *
     * @param  userId {@link String}                 The id of the user to be deactivated.
     * @return {@link User}                          The deactivated user.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     * Unlock a user.
     *
     * @param  userId {@link String}                 The id of the user to be unlocked.
     * @return {@link User}                          The unlocked user.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                 The id of the user to expire password for.
     * @return {@link User}                          The user that has gotten it's password expired.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                 The id of the user to expire password for.
     * @param  tempPassword {@link Boolean}          The new temporary password for the user.
     * @return {@link User}                          The user that has gotten it's password expired.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                 The id of the user to get a reset password link for.
     * @return {@link User}                          The user that has gotten a password reset request.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                 The id of the user to get a reset password link for.
     * @param  sendEmail {@link Boolean}             Determines whether to notify user with an email.
     * @return {@link User}                          The user that has gotten a password reset request.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                 The id of the user to reset password for.
     * @return {@link User}                          The user that has gotten its password reset.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}        The id of the user to reset factors for.
     * @return {@link User}                 The user that has gotten its factors reset.
     * @throws IOException                  If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                        The id of the user to set credentials for.
     * @param  loginCredentials {@link LoginCredentials}    The login credentials for the user.
     * @return {@link User}                                 The user that has gotten its credentials set.
     * @throws IOException                                  If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}        The id of the user to set password for.
     * @param  userPassword {@link String}  The password for the user.
     * @return {@link User}                 The user that has gotten its password set.
     * @throws IOException                  If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}        The id of the user to set recovery question for.
     * @param  question {@link String}      The recovery question for the user.
     * @param  answer {@link String}        The recovery answer for the user.
     * @return {@link User}                 The user that has gotten its recovery question set.
     * @throws IOException                  If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                 The id of the user to change password for.
     * @param  oldPassword {@link String}            The old password for the user.
     * @param  newPassword {@link String}            The new password for the user.
     * @return {@link LoginCredentials}              The login credentials for the user that has gotten its password changed.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  userId {@link String}                        The id of the user to change recovery question for.
     * @param  currentPassword {@link String}               The current password for the user.
     * @param  recoveryQuestion {@link RecoveryQuestion}    The recovery question for the user.
     * @return {@link LoginCredentials}                     The login credentials for the user that has gotten its recovery question changed.
     * @throws IOException                                  If an input or output exception occurred.
     */
     ...
     *
     * @return {@link PagedResults}                  The users with paging info.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  filterBuilder {@link FilterBuilder}   The filter that's being used to match users.
     * @return {@link PagedResults}                  The users with paging info.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  after {@link String}                  The cursor that determines which users to return after.
     * @param  limit {@link Integer}                 The max number of results returned.
     * @return {@link PagedResults}                  The users with paging info.
     * @throws IOException                           If an input or output exception occurred.
     */
     ...
     *
     * @param  filterBuilder {@link FilterBuilder}   The advanced search filter that is being used to match users.
     * @return {@link PagedResults}                  The users with paging info.
     * @throws IOException                           If an input or output exception occurred.
     */
    ...
    /**
     * Returns the API response containing List of Users.
     *
    ...
    /**
     * Returns the API response containing limited number of Users.
     *
     * @param  limit {@link Integer}                 The max number of results returned.
     * @return {@link ApiResponse}                   The API response.
     * @throws IOException                           If an input or output exception occurred.
     */
    ...
    /**
     * Returns the API response containing a List of Users gathered via filter.
     *
     * @param  filterBuilder {@link FilterBuilder}   The advanced search filter that is being used to match users.
     * @return {@link ApiResponse}                   The users with paging info.
     * @throws IOException                           If an input or output exception occurred.
     */
    ...
    /**
     * Returns the API response containing a List of Users gathered via filter and limit.
     *
     * @param  filterBuilder {@link FilterBuilder}   The advanced search filter that is being used to match users.
     * @param  limit {@link Integer}                 The max number of results returned.
     * @return {@link ApiResponse}                   The users with paging info.
    ...
    /**
     * Returns the API response containing a List of Users gathered after input and limit.
     *
     * @param  after {@link String }                 The cursor that determines which users to return after.
     * @param  limit {@link Integer}                 The max number of results returned.
     * @return {@link ApiResponse}                   The users with paging info.
    ...
    /**
     * Returns the API response containing a List of Users gathered via advanced search.
     *
     * @param  filterBuilder {@link FilterBuilder}   The advanced search filter that is being used to match users.
     * @return {@link ApiResponse}                   The users with paging info.
     * @throws IOException                           If an input or output exception occurred.
    ...
    /**
     * Returns the API response containing a List of Users gathered via advanced filter and limit.
     *
     * @param  filterBuilder {@link FilterBuilder}   The advanced search filter that is being used to match users.
     * @param  limit {@link Integer}                 The max number of results returned.
     * @return {@link ApiResponse}                   The users with paging info.
    ...
    /**
     * Returns the API response containing a List of Users gathered via advanced filter, limit, and index.
     *
     * @param  filterBuilder {@link FilterBuilder}   The advanced search filter that is being used to match users.
     * @param  limit {@link Integer}                 The max number of results returned.
     * @param  after {@link String }                 The cursor that determines which users to return after.
    ...
    /**
     * Returns the API response containing a List of Users via URL.
     * @param  url {@link String}                    The URL to get users from.
     * @return {@link ApiResponse}                   The users with paging info.
     * @throws IOException                           If an input or output exception occurred.
     */
