...
class IdpIT extends ITSupport {
    ...
    void oidcIdpLifecycleTest() {
        ...
        protocolAlgorithmTypeSignature_Req.setScope("REQUEST")
        ...
        protocolAlgorithmTypeSignature_Res.setScope("RESPONSE")
        ...
        protocolEndpointAcs.setBinding("HTTP-POST")
        protocolEndpointAcs.setType("INSTANCE")

        ProtocolEndpoint protocolEndpointAuthorization = new ProtocolEndpoint()
        protocolEndpointAuthorization.setBinding("HTTP-POST")
        ...
        provisioningDeprovisionedConditionDeprov.setAction("NONE")
        ...
        provisioningDeprovisionedConditionSusp.setAction("NONE")
        ...
        provisioningGroups.setAction("NONE")
        ...
        policySubject.setMatchType("USERNAME")
        ...
        assertThat(createdIdp.getStatus(), equalTo("ACTIVE"))
    ...
    void linkedInIdpTest() {
        ...
        policyUserNameTemplate.setTemplate("idpuser.email")
        policySubject.setUserNameTemplate(policyUserNameTemplate)
        policySubject.setMatchType("EMAIL")
        identityProviderPolicy.setSubject(policySubject)
        idp.setPolicy(identityProviderPolicy)
