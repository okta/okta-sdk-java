...
/**
 * A disabled implementation that does nothing. This is useful for a CacheManager implementation to return instead of
 * retuning null. Non-null guarantees reduce a program's cyclomatic complexity.
 *
 * @since 0.5.0
 */
