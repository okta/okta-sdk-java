...
public class SystemPropertiesApiKeyCredentialsProvider extends AbstractApiKeyCredentialsProvider {
    ...
    private static final String API_KEY_ID_SYSTEM_PROPERTY = "okta.client.apiKey.id";
    private static final String API_KEY_SECRET_SYSTEM_PROPERTY = "okta.client.apiKey.secret";
