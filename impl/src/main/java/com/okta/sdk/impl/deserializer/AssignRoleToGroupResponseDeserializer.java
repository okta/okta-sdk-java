...
public class AssignRoleToGroupResponseDeserializer extends StdDeserializer<AssignRoleToGroup200Response> {
    ...
    public AssignRoleToGroupResponseDeserializer(Class<?> vc) {
        super(vc);
    }

    @Override
    public AssignRoleToGroup200Response deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        JsonNode node = jp.getCodec().readTree(jp);
        ObjectMapper mapper = (ObjectMapper) jp.getCodec();

        AssignRoleToGroup200Response response = new AssignRoleToGroup200Response();
