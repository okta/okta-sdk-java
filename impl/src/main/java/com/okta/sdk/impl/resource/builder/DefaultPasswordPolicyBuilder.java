...
import com.okta.sdk.resource.PasswordDictionary;
import com.okta.sdk.resource.PasswordDictionaryCommon;
import com.okta.sdk.resource.PasswordPolicy;
import com.okta.sdk.resource.PasswordPolicyConditions;
import com.okta.sdk.resource.PasswordPolicyDelegationSettings;
import com.okta.sdk.resource.PasswordPolicyDelegationSettingsOptions;
import com.okta.sdk.resource.PasswordPolicyPasswordSettings;
import com.okta.sdk.resource.PasswordPolicyPasswordSettingsAge;
import com.okta.sdk.resource.PasswordPolicyPasswordSettingsComplexity;
import com.okta.sdk.resource.PasswordPolicyPasswordSettingsLockout;
import com.okta.sdk.resource.PasswordPolicyRecoveryEmail;
import com.okta.sdk.resource.PasswordPolicyRecoveryEmailProperties;
import com.okta.sdk.resource.PasswordPolicyRecoveryEmailRecoveryToken;
import com.okta.sdk.resource.PasswordPolicyRecoveryFactorSettings;
import com.okta.sdk.resource.PasswordPolicyRecoveryFactors;
import com.okta.sdk.resource.PasswordPolicyRecoverySettings;
import com.okta.sdk.resource.PasswordPolicySettings;
...
import com.okta.sdk.resource.PasswordPolicyAuthenticationProviderCondition;
...
public class DefaultPasswordPolicyBuilder extends DefaultPolicyBuilder<PasswordPolicyBuilder> implements PasswordPolicyBuilder {
    ...
    private PasswordPolicy build(Client client) {
        ...
        if (Objects.nonNull(pwdPolicyRecoveryEmailStatus))
            ((AbstractResource) passwordPolicyRecoveryEmail).setProperty("status", pwdPolicyRecoveryEmailStatus);
