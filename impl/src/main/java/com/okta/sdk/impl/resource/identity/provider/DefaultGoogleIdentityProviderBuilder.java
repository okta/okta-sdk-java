...
public class DefaultGoogleIdentityProviderBuilder implements GoogleIdentityProviderBuilder {
    ...
    @Override
    public DefaultGoogleIdentityProviderBuilder setProtocolType(Protocol.TypeEnum protocolType) {
