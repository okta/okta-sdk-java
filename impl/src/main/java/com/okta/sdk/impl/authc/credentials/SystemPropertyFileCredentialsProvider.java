...
public class SystemPropertyFileCredentialsProvider extends AbstractApiKeyCredentialsProvider {
    ...
    private static final String API_KEY_FILE_LOCATION_SYSTEM_PROPERTY = "okta.client.apiKey.file";
    private static final String ERROR_MSG = "Unable to load api key properties file [{}] specified by system property okta.client.apiKey.file. " +
